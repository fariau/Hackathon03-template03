            ...
            <section className="my-20">
                <div className="flex flex-col justify-center items-center max-w-lg mx-auto">
                    ...
                    <div className="flex justify-between max-w-[280px] mx-auto mt-6">
                        <h1 className="text-[#8D8D8D] text-[12px] flex gap-1 items-center"><input type="checkox" />Sign up for emails to get updates from Nike on products, offers and your Member benefits</h1>
                    </div>
                    <div className="flex flex-col justify-center items-center mt-4">
                        <p className="text-[#8D8D8D] text-[12px]">By creating an account, you agree to Nike&apos;s <u>Privacy Policy</u></p>
                        <p className="text-[#8D8D8D] text-[12px]">and <u>Terms of Use</u></p>
                    </div>
                    <Link href={"/joinus"} ><Button className="w-80 ronded-sm my-6">JOIN US</Button></Link>
                    <p className="text-[#8D8D8D] text-[12px]">Already a Member <Link href={"/login"}><u className="text-black">Sign In?</u></Link></p>
                </div>
            </section>
        </main>
    )
