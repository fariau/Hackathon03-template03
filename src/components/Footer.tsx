...
<div className="flex justify-start  gap-10 flex-wrap" >
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          <li><Link href="#" className="hover:underline text-gray-500">Order Status</Link></li>
          ...
          <li><Link href="#" className="hover:underline  text-gray-500">Contact Us on Nike.com</Link></li>
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          <li><Link href="#" className="hover:underline  text-gray-500">News</Link></li>
          <li><Link href="#" className="hover:underline  text-gray-500">Careers</Link></li>
          <li><Link href="#" className="hover:underline  text-gray-500">Investors</Link></li>
          <li><Link href="#" className="hover:underline  text-gray-500">Sustainability</Link></li>
        </ul>
      </div>
</div>
